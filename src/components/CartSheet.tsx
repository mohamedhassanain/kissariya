...
export function CartSheet() {
  ...
  const handleWhatsAppOrder = (shopId: string, shopItems: CartItem[]) => {
...
Pouvez-vous confirmer la disponibilité?`;
    ...
    const whatsappUrl = `https://wa.me/${formatWhatsAppNumber(shop.whatsapp_number)}?text=${encodeURIComponent(message)}`;
