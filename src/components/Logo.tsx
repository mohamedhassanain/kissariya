...
function InlineSVG({ className = 'h-8 w-8', title = 'KissariyaMaroc' }: Readonly<{ className?: string; title?: string }>) {
  return (
    <svg
...
export default function Logo({ className = 'h-8 w-8', title = 'KissariyaMaroc' }: Readonly<LogoProps>) {
  return (
