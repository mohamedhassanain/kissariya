...
function ProductCard({ 
  ...
  const renderPrice = () => {
    if (product.is_promotion && product.original_price) {
      return (
        <>
    ...
    return <span className="font-bold">{product.price} DH</span>;
  };
    ...
    <Card className="border-2 hover:shadow-lg transition-all group">
      <CardContent className="p-4">
        <div className="flex gap-4">
          {/* Product Image */}
          <div className="w-20 h-20 rounded-lg bg-slate-50 overflow-hidden flex-shrink-0 flex items-center justify-center border">
            {displayImage ? (
              <img 
                src={displayImage} 
                alt={product.name}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground flex items-center gap-1 uppercase">
