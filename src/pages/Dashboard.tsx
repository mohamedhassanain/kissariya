...
export default function Dashboard() {
      ...
      <div className="min-h-screen bg-background p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {['db-sk-1', 'db-sk-2', 'db-sk-3', 'db-sk-4'].map((key) => (
  ...
  const catalogUrl = `${globalThis.location.origin}/c/${shop.slug}`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {shop.logo_url ? (
                <div className="h-10 w-10 rounded-xl overflow-hidden flex items-center justify-center bg-slate-50">
                  <img 
                    src={shop.logo_url} 
                    alt={shop.name}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 mb-8">
          <Button asChild className="gradient-primary text-primary-foreground shadow-lg col-span-2 sm:col-auto">
            <Link to="/products/new">
              <Plus className="h-4 w-4 mr-2" />
              Ajouter un produit
            </Link>
          </Button>
          <Button variant="outline" onClick={handleShare} className="justify-start sm:justify-center">
          ...
          <Button variant="secondary" asChild className="col-span-2 sm:col-auto">
            <a href={catalogUrl} target="_blank" rel="noopener noreferrer">
              <Eye className="h-4 w-4 mr-2" />
              Voir ma boutique
            </a>
          </Button>
          <Button variant="outline" asChild className="col-span-2 sm:col-auto">
